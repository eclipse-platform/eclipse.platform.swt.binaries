...
# Use this file (gtk.linux.x86_64_rhel4.csh) to compile and release only these 3 libraries:
#   libswt-mozilla-gtk-XXXX.so
#   libswt-xpcominit-gtk-XXXX.so
#   libswt-xulrunner-gtk-XXXX.so
# Use gtk.linux.x86_64_rhel3.csh to compile and release the remaining libraries
